...
def test_image(pil_input):
  random_image = ToTensor()(pil_input).to(device)
  random_image = random_image[None, :]
  print(random_image.shape)
  print(type(random_image))
  net_output = netG(random_image)
  print(net_output.shape)
  net_output = net_output.squeeze()
  print(net_output.shape)
  pil_output = T.ToPILImage()(net_output)
  pil_output.save(".foo.jpg")
  return pil_output
...
load_checkpoint("./g_150.pth", netG.eval(), optimizerG, lr=0.0001)
